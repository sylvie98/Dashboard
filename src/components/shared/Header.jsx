...
const Header = () => {
  return (
    <div className='bg-white h-16 px-4 flex justify-between items-center shadow-lg w-[40rem]'>
          ...
          {({ open }) => (
            <>
              ...
              <Transition
                ...
                leaveTo=""
              >
                <Popover.Panel className=" pt-60 w-[10rem]">
                  <div className="rounded-lg shadow-lg  h-[15rem]  px-5 pt-4 bg-white">
